const strings = {
  ...
  aboutChange3: "Des weiteren haben wir uns auf eine 3 Runden pro Spieltag geeinigt, damit es nicht zu Nachteilen kommt, wenn man an einem Sonntag mal nicht kann.",
  rulesHeader: "Regeln",
  rule1: "Solltest du deinen Namen zurücksetzen beginnst du wieder mit den 1000 Punkten vom Anfang.",
  ...
  participateText2: "Einer der Moderatoren wird vor jeder Runde fragen, wer teilnehmen möchte. Diesem musst du dann im Flüster-Chat antworten, solltest du teilnehmen wollen. An jedem Sonntag wird es 3 Runden geben, jedoch bist du nicht verpflichted an jeder teilzunehmen.",
