const strings = {
  ...
  aboutText: "La FloLeague è un torneo PvP 1v1 per Florensia, un gioco MMORPG. La classifica del campionato si basa su un elo-rating simile agli scacchi o alla League of Legends. Al termine della stagione i vincitori verranno premiati. La stagione va da {startDate} a {endDate}.",
  aboutTeam: "I seguenti giocatori fanno parte della squadra di moderatori del campionato:",
  rulesHeader: "Regole",
  ...
  prizesHeader: "Premi",
  prizesDisclaimer: "Per guadagnare premi, dovrai partecipare ad almeno 8 partite.",
